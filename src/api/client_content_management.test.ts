...
const mockBaseUrl = "http://backend:8000";
jest.mock("./client", () => {
  ...
  return {
    ...
    contentManagementClient: originalModule.contentManagementClient,
  };
});
  ...
  describe("getCarouselImages", () => {
    it("fetches carousel images correctly", async () => {
      ...
      expect(response).toEqual([
        {
          imageUrl: "http://backend:8000/image1.jpg",
          title: "Image 1",
          description: "Description 1",
        },
        {
          imageUrl: "http://backend:8000/image2.jpg",
          title: "Image 2",
          description: "Description 2",
        },
      ]);
